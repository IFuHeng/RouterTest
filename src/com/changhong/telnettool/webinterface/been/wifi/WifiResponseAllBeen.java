...
public class WifiResponseAllBeen extends BaseResponseBeen {
    ...
    public WifiResponseAllBeen clone() {
        WifiResponseAllBeen newOne = new WifiResponseAllBeen();

        for (Field field : getClass().getDeclaredFields()) {
            try {
                Object obj = field.get(this);
                field.set(newOne, obj);
    ...
    public void setAp_infos(List<Level2Been> ap_infos) {
        this.ap_infos = ap_infos;
    }
    ...
    public void setMac_list(List<Group> mac_list) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof WifiResponseAllBeen)) return false;
        WifiResponseAllBeen that = (WifiResponseAllBeen) o;
